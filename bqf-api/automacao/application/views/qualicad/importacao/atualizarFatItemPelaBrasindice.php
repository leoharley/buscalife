<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Atualiza FatItem pela Brasindice
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="importFrm">
            <form action="<?php echo base_url() ?>atualizaFatItemPelaBrasindice" method="post" enctype="multipart/form-data">
