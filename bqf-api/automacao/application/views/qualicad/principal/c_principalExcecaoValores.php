                        ...
                        <div class="box-body">
                            ...
                            <div class="row" style="display: inline-block;width: 98%;height: 100%;margin: 0.15rem;padding-top: 0.85rem;padding-left:1rem;padding-right:1rem;
                                ...
                                <tr id="row0">
                                            ...
                                            <input type="text" style="pointer-events:none" class="form-control" value="<?php echo ($this->uri->segment(2) == 'cadastrar') ? set_value('IdExcecaoValores') : $Id_ExcValores ; ?>" id="IdExcecaoValores" name="IdExcecaoValores">
                                            </td>
                                         ...
                                         <!--   <td>
                                            ...
                                            <select id="itemName" class="form-control" style="width:300px" name="Cd_ProFat"></select>
                                            </td>
