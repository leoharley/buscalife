...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> Importa Pacote
        </h1>
    </section>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="importFrm">
            <form action="<?php echo base_url() ?>importaPacote" method="post" enctype="multipart/form-data">
                <br/>
                <br/>
        ...
        <a class="btn btn-primary" href="<?php echo base_url(). 'exportaPacote/'.$this->session->flashdata('num_linhas_importadas'); ?>" <?php if ($this->session->flashdata('num_linhas_importadas') == null) {echo 'disabled'; echo ' onclick=\'return false;\''; } ?>>
            <i class="fa fa-upload"></i> Exportar importação atual</a>
        <a class="btn btn-primary" href="<?php echo base_url(); ?>exportaPacote/0">
